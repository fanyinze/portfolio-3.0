            ...
            <div className='section-content'>
                ...
                <div className='intro-container'>
                    ...
                    <div className='intro'>
                        <p>
                            <strong>
                                I am Yinze Fan and I am a computer engineer.
                            </strong>
                            I graduated from University of Toronto. My favorite
                            subjects at university were all the ones related
                            with software development. The main reason I am
                            passionate about developing is that I can leverage
                            my creativity, because there are so many ways to
                            achieve the same goal when you code a software and I
                            like to find the optimal one for each scenario
                        </p>
                    </div>
                </div>
